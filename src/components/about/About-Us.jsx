        ...
        <div>
                ...
                <ul className="grid place-content-center sm:grid-cols-2 gap-8 w-4/5 mx-auto">
                    <li className="flex max-w-5xl shadow-md p-3 py-4 rounded-lg bg-gray-50 border">
                        ...
                        <div className="w-full flex flex-col justify-center">
                            ...
                            <p className="text-gray-600 py-2 text-sm">We love numbers! We collect data and
                    ...
                    <li className="flex max-w-5xl shadow-md p-3 py-4 rounded-lg bg-gray-50 border">
                        ...
                        <div>
                            <div className="text-xl font-bold text-gray-600 text-center">Vision</div>
                            <p className="py-2 text-sm">Solutions are born from proper
            ...
            <div className="bg-gray-100 pb-20">
                ...
                <div className="text-center">
                    <h2 className="font-semibold text-3xl text-center">Business Model</h2>
